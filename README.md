...
- Preview: https://main--adobe-storefront-with-shop-pay--twg.hlx.page
- Live: https://main--adobe-storefront-with-shop-pay--twg.hlx.live/
...
1. Open the `adobe-storefront-with-shop-pay` directory in your favorite IDE and start coding :)
